...
<main class="form-signin w-100 m-auto">
  <form>
    <img class="mb-4" src="../assets/brand/bootstrap-logo.svg" alt="" width="72" height="57" method="POST" action="login.php">>
    ...
    <button class="w-100 btn btn-lg btn-primary" type="submit">Inicia</button>
