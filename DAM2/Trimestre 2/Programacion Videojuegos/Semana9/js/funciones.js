...
function dibujarProps2() {
    contextomapaprops.drawImage(mapaprops2, 0, 0);
    var anchurabloque = 50;
    var anchuradibujo = 120;
    //console.log("dibujo un prop");
    ...
    for (var i = 0; i < pixeles.data.length; i += 4) {
        ...
        if (cg === 255) {
            ...
            contexto.drawImage(
                sur,
                isox(x * anchurabloque, y * anchurabloque) + desfasex,
                isoy(x * anchurabloque, y * anchurabloque) + desfasey - pixeles.data[i]*alturabloquez-50,
                anchuradibujo, anchuradibujo // Tamaño del frame
            );
        }else if(cg === 200){
            contexto.drawImage(
...
function dibujarProps3() {
    contextomapaprops.drawImage(mapaprops3, 0, 0);
    var anchurabloque = 50;
    var anchuradibujo = 120;
    //console.log("dibujo un prop");
    ...
    for (var i = 0; i < pixeles.data.length; i += 4) {
        ...
        if (cg === 255) {
            ...
            contexto.drawImage(
                sur,
                isox(x * anchurabloque, y * anchurabloque) + desfasex,
                isoy(x * anchurabloque, y * anchurabloque) + desfasey - pixeles.data[i]*alturabloquez-100,
                anchuradibujo, anchuradibujo // Tamaño del frame
            );
        }else if(cg === 200){
            contexto.drawImage(
