...
int main(int argc, char *argv[]){
    ...
    strcpy(agenda[3].Artista,"Led Zeppeln");
    ...
    switch(opcion){
        ...
        case '2':
            /*
            printf("Introducir un registro:\n");
            printf("Título del CD: ");
            scanf("%s", agenda[num_registros].TituloCD);
            printf("Artista: ");
            scanf("%s", agenda[num_registros].Artista);
            printf("Año de lanzamiento: ");
            scanf("%s", agenda[num_registros].AnioLanzamiento);
            printf("Género musical: ");
            scanf("%s", agenda[num_registros].Genero);

            num_registros++; // Incrementa el contador de registros
